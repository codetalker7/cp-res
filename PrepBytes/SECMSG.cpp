...
/*
	 ...
	 file name: SECMSG.cpp
	 date created: 2021-10-11 15:28:35
	 problem link: https://mycode.prepbytes.com/contest/MARATHONOCT21/problems/SECMSG
*/
#include<iostream>
#include<vector>
#include<string>
