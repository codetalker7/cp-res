...
/*
	 ...
	 file name: ANDSUBAR.cpp
	 date created: 2021-10-05 20:24:34
	 problem link: https://www.codechef.com/OCT21A/problems/ANDSUBAR
*/
#include<iostream>
#include<vector>
#include<string>
...
void solve(ll mcase){
    ...
    ll k = log_base_2(n).first;
    ll inf = 1e18;
    printf("%lld\n", max(n - expo((ll)2, k, inf) + 1, expo((ll)2, k - 1, inf)));
}
