...
/*
	 ...
	 file name: Binary-Inversions
	 date created: 2021-05-16 23:54:29
	 problem link: https://www.hackerearth.com/challenges/competitive/may-circuits-21/algorithm/binary-inversions-cf645357/
*/
#include<iostream>
#include<vector>
#include<string>
...
*/
    ...
    */
    ...
    //if we have a 0s and b 1s, the maximum possible inversions is ab
    if (x > a*(n - a)){
    	cout << -1;
    	exit(0);
    }
