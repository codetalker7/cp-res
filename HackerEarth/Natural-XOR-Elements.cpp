...
/*
	 ...
	 file name: Natural-XOR-Elements
	 date created: 2021-05-17 12:50:40
	 problem link: https://www.hackerearth.com/challenges/competitive/may-circuits-21/algorithm/natural-xor-25d22168/
*/
#include<iostream>
#include<vector>
#include<string>
...
void solve(ll mcase){
	...
	//so we assume that N >= 4, i.e N has atleast three digits
	//N % 4 is the number formed by the last two binary digits of N
	ll y = N % 4;
