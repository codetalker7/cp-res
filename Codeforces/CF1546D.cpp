...
/*
	 ...
	 file name: CF1546D.cpp
	 date created: 2021-08-17 15:28:34
	 problem link: https://codeforces.com/contest/1546/problem/D
*/
#include<iostream>
#include<vector>
#include<string>
...
void solve(ll mcase){
    ...
    //final answer is \binom{ones + k - 1}{k - 1}
    ll a = factorialModulo(ones + k - 1);
    ll b = factorialModulo(k - 1);
    ll c = factorialModulo(ones);

    ll x, y;
    ll ans = (a * modinv(b, MOD, x, y)) % MOD;
    ans = (ans * modinv(c, MOD, x, y)) % MOD;
    printf("%lld\n", ans);
}
