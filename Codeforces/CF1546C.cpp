...
/*
	 ...
	 file name: CF1546C.cpp
	 date created: 2021-08-16 23:25:41
	 problem link: 
*/
#include<iostream>
#include<vector>
...
ll freqEvenSorted[100000 + 1];
ll freqEvenUnSorted[100000 + 1];
ll freqOddSorted[100000 + 1];
ll freqOddUnSorted[100000 + 1];
ll a[100000 + 1];
...
void solve(ll mcase){
    ...
    memset(freqEvenSorted, 0, 100001*sizeof(ll));
    memset(freqEvenUnSorted, 0, 100001*sizeof(ll));
    memset(freqOddSorted, 0, 100001*sizeof(ll));
    memset(freqOddUnSorted, 0, 100001*sizeof(ll));
    ...
    for (ll i = 1; i <= n; i++){
        ll b = a[i];
        if (freqEvenSorted[b] != freqEvenUnSorted[b] || freqOddSorted[b] != freqOddUnSorted[b]){
            printf("NO\n");
            return;
        }
    }
