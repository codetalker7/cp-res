...
/*
	 ...
	 file name: CF1534D
	 date created: 2021-06-24 00:50:02
	 problem link: https://codeforces.com/contest/1534/problem/D
*/
#include<iostream>
#include<vector>
#include<string>
...
void solve(ll mcase){
    ...
    //finding the tree
    for (ll i = 0; i < ssz(to_iterate); i++){
        ll curr_vertex = to_iterate[i];
        if (curr_vertex == 1)
            continue;
        printf("? %lld\n", curr_vertex);
        fflush(stdout);
