...
/*
	 ...
	 file name: abc203_c
	 date created: 2021-05-30 17:40:02
	 problem link: https://atcoder.jp/contests/abc203/tasks/abc203_c
*/
#include<iostream>
#include<vector>
#include<string>
...
void solve(){
    ...
    ll curr_pos = 0 , i = 0;
    while(curr_pos + K >= friends[i].first && i < N){
        K -= friends[i].first - curr_pos;
        K += friends[i].second;
        curr_pos = friends[i].first;
        i++;
    }
    cout << curr_pos + K;
}
